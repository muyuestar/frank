...
public class ImageUtils {
     ...
     * @throws Exception
     * @author kst, 2024.1.15
     */
    public static void connectImage(String[] imagePaths, String destImageFile) throws Exception {
        BufferedImage image1 = ImageIO.read(new File(imagePaths[0]));
        BufferedImage image2 = ImageIO.read(new File(imagePaths[1]));
        ...
        g.drawImage(image2, 0, image2.getHeight(), null);
        g.dispose();

        ImageIO.write(mergedImage, "jpg", new File(destImageFile));
    }
