 ...
 * 
 * @author kst
 * @date 2021-08-12 22:18:54
 *       https://blog.csdn.net/taisuiyu6397/article/details/107086902/
 */
public class Sm4Util3 {
	...
	public static void main(String[] args) throws IOException {
		Sm4Util3 sm4 = new Sm4Util3();
		String pin = "000000";
		String key = "64F3BC528091A3649A0C9EAEFFAA32B4";
		String encodePin = sm4.encode(pin, key);
		System.out.println(encodePin);

		String decodePin = sm4.decode(encodePin, key);
