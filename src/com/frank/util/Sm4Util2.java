...
public class Sm4Util2 {
	...
	public static String encodeSMS4ToHex(String plaintext, byte[] key) {
		return bytesToHexString(Sm4Util2.encodeSMS4(plaintext, key));
	}
	...
	public static String decodeSMS4HexToString(String enHex, byte[] key) {
		return Sm4Util2.decodeSMS4toString(hexStringToBytes(enHex), key);
	}
	...
	private static byte[] encodeSMS4(String plaintext, byte[] key) {
		...
		return Sm4Util2.encodeSMS4(plaintext.getBytes(), key);
	}
	...
	public static void main(String[] args) {
		final byte[] key = { 0x09, 0x25, 0x41, 0x65, (byte) 0x90, (byte) 0xaa, (byte) 0xcf, (byte) 0xde, (byte) 0xfa,
				(byte) 0xdc, (byte) 0xea, (byte) 0x01, 0x13, 0x36, 0x71, 0x50 };
		// 52e146c73bfe611682d50b388e77ced7
		String name = "123456";

		String enStr = encodeSMS4ToHex(name, key);
